  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    if (validateForm()) {
      ...
      try {
        ...
        // Only showing the relevant part that needs to be modified
        const handleSubmit = async (e: React.FormEvent) => {
          e.preventDefault();
          ...
          if (validateForm()) {
            ...
            try {
              ...
              // Ensure codechefHandle is properly handled when empty
              const submissionData = {
                ...formData,
                codechefHandle: formData.codechefHandle.trim() || "" // Ensure empty string is passed when no value
              };
